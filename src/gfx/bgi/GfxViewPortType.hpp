...
class GfxViewPortType final : public GfxObject
{
public:
    typedef prv::GfxCanvasBgi::viewporttype BgiType;

    static const char ClassName[];
    static const bool SdlResource = false;
    static const bool CallsSdl = false;

    GfxViewPortType() noexcept;
