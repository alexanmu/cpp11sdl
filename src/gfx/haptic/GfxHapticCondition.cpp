...
GfxHapticCondition::GfxHapticCondition(GfxHapticCondition const& other) noexcept : GfxObject(other)
{
    LOG_TRACE_PRIO_MED();
...
GfxHapticCondition& GfxHapticCondition::operator=(GfxHapticCondition const& other) noexcept
{
    LOG_TRACE_PRIO_MED();
