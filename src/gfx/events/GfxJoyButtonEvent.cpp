...
GfxJoyButtonEvent::GfxJoyButtonEvent(GfxJoyButtonEvent const& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxJoyButtonEvent::GfxJoyButtonEvent(GfxJoyButtonEvent&& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxCommonEvent GfxJoyButtonEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxJoyButtonEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
