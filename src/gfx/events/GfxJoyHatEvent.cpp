...
GfxJoyHatEvent::GfxJoyHatEvent(GfxJoyHatEvent const& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxJoyHatEvent::GfxJoyHatEvent(GfxJoyHatEvent&& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxCommonEvent GfxJoyHatEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxJoyHatEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxHatPosition GfxJoyHatEvent::getPosition(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
