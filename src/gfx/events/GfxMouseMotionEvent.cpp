...
GfxMouseMotionEvent::GfxMouseMotionEvent(GfxMouseMotionEvent const& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxMouseMotionEvent::GfxMouseMotionEvent(GfxMouseMotionEvent&& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
