...
GfxJoyAxisEvent::GfxJoyAxisEvent(GfxJoyAxisEvent const& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxJoyAxisEvent::GfxJoyAxisEvent(GfxJoyAxisEvent&& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxCommonEvent GfxJoyAxisEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxJoyAxisEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
