...
GfxCommonEvent GfxControllerDeviceEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxControllerDeviceEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
