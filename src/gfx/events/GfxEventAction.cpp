...
GfxEventAction::GfxEventAction(const GfxEventAction& other) noexcept : GfxObject(other)
{
    LOG_TRACE_PRIO_MED();
...
GfxEventAction& GfxEventAction::operator=(const GfxEventAction& other) noexcept
{
    LOG_TRACE_PRIO_MED();
