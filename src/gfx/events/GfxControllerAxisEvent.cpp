...
GfxCommonEvent GfxControllerAxisEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxControllerAxisEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
