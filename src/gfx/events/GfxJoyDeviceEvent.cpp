...
GfxJoyDeviceEvent::GfxJoyDeviceEvent(GfxJoyDeviceEvent const& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxJoyDeviceEvent::GfxJoyDeviceEvent(GfxJoyDeviceEvent&& other) noexcept : GfxObject(ClassName)
{
    LOG_TRACE_PRIO_MED();
...
GfxCommonEvent GfxJoyDeviceEvent::getCommonEvent(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
...
joystick::GfxJoystickID GfxJoyDeviceEvent::getJoystickID(void) const noexcept
{
    LOG_TRACE_PRIO_LOW();
