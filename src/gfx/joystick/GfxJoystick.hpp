...
public:
    ...
    GfxJoystickType joystickGetDeviceType(const int32_t index) const noexcept;
    GfxJoystickID joystickGetDeviceInstanceID(const int32_t index) const noexcept;
    std::string joystickName(void) const noexcept;
    GfxJoystickGUID joystickGetGUID(void) const noexcept;
    ...
    GfxJoystickType joystickGetType(void) const noexcept;
    std::string joystickGetGUIDString(GfxJoystickGUID const& guid) const noexcept;
    GfxJoystickGUID joystickGetGUIDFromString(std::string const guid) const noexcept;
    GfxBool joystickGetAttached(void) const noexcept;
    GfxJoystickID joystickInstanceID(void) const noexcept;
    ...
    GfxJoystickPowerLevel joystickCurrentPowerLevel(void) const noexcept;
